...
init python:
    ...
    # 加载英文字幕翻译字典
    import json, os
    _translations_path = os.path.join(os.path.dirname(__file__), "translations_en.json")
    if os.path.exists(_translations_path):
        try:
            with open(_translations_path, "r", encoding="utf-8") as _f:
                _en = {}
                for _entry in json.load(_f):
                    _en[_entry["zh"]] = _entry["en"]
        except:
            _en = {}
    else:
        _en = {}
...
label splashscreen:
    ...
    window show
    "独立制作 by BarryShow"
    "感谢 Ren'Py 引擎与 Claude Code 的辅助支持"
    "A Visual Novel by BarryShow | Built with Ren'Py & Claude Code"
    window hide
...
label start:
    ...
    # play sound camera_shutter  # 音效文件待添加
    我 "（咔嚓。）"
...
label chapter_2:
    ...
    # ---- 处理伤口 ----
    # play music bgm_soft fadein 1.0
    ...
    # play music bgm_encounter fadein 1.0
    ...
    # play music bgm_sunset fadein 1.0
...
label river_confession_foreshadow:
    ...
    # play music bgm_dream fadein 1.0
...
label chapter_5:
    ...
    # play sound env_rain_heavy loop True
    ...
    # play music bgm_confession fadein 1.0
    ...
    # ---- 基于好感度和信任度的告白分支 ----
    if anya_affection >= 135 and trust_level >= 105:
        # 完美告白结局
        我 "安雅，我喜欢你。"
...
label chapter_6:
    ...
    show weather_sunny
    # play music bgm_tense fadein 1.0    # play sound env_crowd_far fadein 0.3
    ...
    # play music bgm_dramatic fadein 1.0    # play sound env_crowd_applause
    ...
    $ anya_affection += 4
    # play sound env_crowd_applause

    我 "（心脏猛地一跳，看着台上闪闪发光的她，心里充满了骄傲和感动。）"
    我 "（那个曾经在漫展角落独自舔舐伤口的女孩，现在已经站在了属于自己的舞台上。）"

    scene bg_conference_hall_backstage at bg_cover with fade
    # play music bgm_happy fadein 1.0    # play sound env_crowd_cheer fadein 0.3
...
label perfect_ending_ch6:
    ...
    show weather_clear
    # play music bgm_romantic fadein 1.0    # play sound env_crickets fadein 0.3
    ...
    show weather_sunny
    # play music bgm_ending fadein 1.0
    我 "（一年后。）"
...
label normal_ending_ch6:
    ...
    show weather_sunny
    # play music bgm_hopeful fadein 1.0
    show anya wave at anya_std zorder 10
    anya "我走了！等我回来！"
...
label sad_ending_ch6:
    ...
    # play music bgm_sad fadein 1.0    # play sound env_rain_light
    ...
    show weather_heavy_rain
    # play sound env_airport_announcement fadein 0.3
